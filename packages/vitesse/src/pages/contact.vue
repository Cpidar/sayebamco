<template>
  ...
  <div class="bg-warm-gray-50">
    <div class="relative z-10 overflow-hidden py-24 lg:py-32">
      <div class="max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
        <h1
          class="text-4xl font-extrabold tracking-tight text-warm-gray-900 sm:text-5xl lg:text-6xl"
        >با ما در تماس باشید</h1>
  ...
  <!-- Contact section -->
  <section class="relative bg-white mb-8" aria-labelledby="contactHeading">
    <div class="absolute w-full h-1/2 bg-warm-gray-50" aria-hidden="true"></div>
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <svg
        class="absolute top-0 right-0 transform -translate-y-16 translate-x-1/2 sm:translate-x-1/4 md:-translate-y-24 lg:-translate-y-72"
        width="404"
        height="384"
        fill="none"
        viewBox="0 0 404 384"
      ...
      <div class="relative bg-white shadow-xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3">
          ...
          >
            ...
            <h3 class="text-lg font-medium text-white">اطلاعات تماس</h3>
            <p class="mt-6 text-base text-teal-50 max-w-3xl">اصفهان، دهاقان، ناحیه صنعتی گلشن</p>
          ...
          <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
            <h3 class="text-lg font-medium text-warm-gray-900">ارسال پیام</h3>
            <form
              action="#"
              method="POST"
            ...
            >
              ...
              <div>
                <label for="email" class="block text-sm font-medium text-warm-gray-900">ایمیل</label>
                <div class="mt-1">
                  <input
                    id="email"
                    name="email"
              ...
              <div>
                <div class="flex justify-between">
                  <label for="phone" class="block text-sm font-medium text-warm-gray-900">تلفن</label>
                  <span id="phone-optional" class="text-sm text-warm-gray-500">اختیاری</span>
                </div>
                <div class="mt-1">
                  <input
                    type="text"
              ...
              <div class="sm:col-span-2">
                <label for="subject" class="block text-sm font-medium text-warm-gray-900">موضوع</label>
                <div class="mt-1">
                  <input
                    type="text"
                    name="subject"
              ...
              <div class="sm:col-span-2">
                <div class="flex justify-between">
                  <label for="message" class="block text-sm font-medium text-warm-gray-900">متن پیام</label>
                  <span id="message-max" class="text-sm text-warm-gray-500">حداکثر 500 کاراکتر</span>
                </div>
                <div class="mt-1">
                  <textarea
                    id="message"
